...
class _DoneProjectsTabCreatedState extends State<DoneProjectsTabCreated> {
  List<ProjectItem> _doneProjectsTabList = <ProjectItem>[
    ...
    ProjectItem(
      title: 'پروژه اول شما',
      caption: 'اینجا توضیح کوتاهی درمورد اولین پروژه شما نوشته خواهد شد.اینجا توضیح کوتاهی درمورد اولین پروژه شما نوشته خواهد شد.اینجا توضیح کوتاهی درمورد اولین پروژه شما نوشته خواهد شد.اینجا توضیح کوتاهی درمورد اولین پروژه شما نوشته خواهد شد',
      creator: User(
        'آتنا',
        'گنجی',
      ),
